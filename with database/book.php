...
echo "Select course to add books:";
...
<tr>
<td>Book Title:</td>
<td><input type="type" id="bt" name="booktitle"  />
 </td>

</tr>
<tr>
<td>Book Edition:</td>
<td><select name="bookedition" id="be">
...
<td><select name="bookpublisher" id="bp">
...
<select name="Date" id="date"><option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
<option value="5">5</option>
